...
public class RegisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                String phone_number = inputPhone_number.getText().toString().trim();


                if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty()  && !age.isEmpty() && !nationality.isEmpty() && !phone_number.isEmpty()) {
                    registerUser(name, email, password,age, nationality,phone_number);
                } else {
    ...
    private void registerUser(final String name, final String email,
                              final String password, final String age, final String nationality, final String phone_number) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        //// check if this works without

                        // Inserting row in users table
                        db.addUser(name, email, uid, created_at, age, nationality, phone_number);
